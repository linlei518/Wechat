...
{/// <summary>
    ...
    public class ExcelHelper
    {
        ...
        public static ArrayList GetExcelTables(string ExcelFileName)
        {
            ...
            {
                using (OleDbConnection conn = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + ExcelFileName + ";Extended Properties='Excel 12.0;HDR=YES';"))
                {
                    try
                    {
                        conn.Open();
        ...
        public static DataTable InputFromExcel(string ExcelFilePath, string TableName)
        {
            ...
            OleDbConnection dbcon = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + ExcelFilePath + ";Extended Properties='Excel 12.0;HDR=YES';");
        ...
        /// 导出传入的控件格式的文档
        /// </summary>
        /// <param name="type">word/excel</param>
        /// <param name="pageContraol">页面控件</param>
        /// <param name="title">导出的名称</param>
        /// <returns></returns>
        public static bool ExportExcel(string type, Control pageContraol, string title)
        {
                ...
                HttpContext.Current.Response.AppendHeader("Content-Disposition", "attachment;filename=" + HttpUtility.UrlEncode(title + houzui, System.Text.Encoding.UTF8));
                HttpContext.Current.Response.ContentEncoding = System.Text.Encoding.GetEncoding("GB2312");
                HttpContext.Current.Response.ContentType = "application/ms-" + type;
                HttpContext.Current.Response.Write("<meta http-equiv=Content-Type content=\"text/html; charset=GB2312\">");
                pageContraol.EnableViewState = false;
                System.IO.StringWriter oStringWriter = new System.IO.StringWriter();
                HtmlTextWriter oHtmlTextWriter = new HtmlTextWriter(oStringWriter);
            


                pageContraol.RenderControl(oHtmlTextWriter);
        ...
        /// <summary>
        /// 将页面的html导出成word，并默认下载
        /// </summary>
        /// <param name="pageContraol"></param>
        /// <param name="path"></param>
        /// <returns></returns>
        public static bool HtmlExportWord(Control pageContraol, string path)
        {
            try
            {
                ...
                System.IO.StreamWriter prinft = new System.IO.StreamWriter(path);
                prinft.Write(oStringWriter.ToString());
                prinft.Flush();
                prinft.Close();
            }
            catch (Exception)
