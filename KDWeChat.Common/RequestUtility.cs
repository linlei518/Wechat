...
namespace KDWechat.Common
{
    public static class RequestUtility
    {
        ...
        /// <param name="url"></param>
        /// <returns></returns>
        public static string HttpPostForQiJia(string url, CookieContainer cookieContainer = null, string fileName = null, Encoding encoding = null)
        {
            //读取文件
            var fileStream = GetFileStream(fileName);
            return HttpPost(url, cookieContainer, fileStream, true, encoding);
        ...
        public static string HttpPostWithEncoding(string url, Stream postStream,Encoding encoding,string userAgent="")
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "POST";
            request.ContentType = "text/xml";
