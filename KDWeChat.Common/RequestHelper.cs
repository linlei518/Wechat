    ...
    public class RequestHelper
    {
        ...
        public static string GetCurrentFullHost()
        {
            ...
            if (!request.Url.IsDefaultPort)
                 url=string.Format("{0}:{1}", request.Url.Host, request.Url.Port.ToString());
        ...
        public static string GetQueryString(string strName, bool sqlSafeCheck)
        {
            ...
            return  Utils.DropHTML( Utils.Filter(HttpContext.Current.Request.QueryString[strName]));
        }
        ...
        public static string GetFormString(string strName, bool sqlSafeCheck)
        {
            ...
            return Utils.DropHTML( Utils.Filter( HttpContext.Current.Request.Form[strName]));
        }
        ...
        {
            return Utils.DropHTML(GetString(strName, false));
        }
