<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="group_list.aspx.cs" Inherits="KDWechat.Web.fans.group_list" %>
...
<body>
	...
	<div class="titlePanel_01">
		...
		</div><%= isAdd?"<a href=\"javascript:bombbox.openBox('group_edit.aspx?m_id="+m_id+"');\" class=\"btn btn3\"><i class=\"add\"></i>新建分组</a>":""%>
		</div>
		<h1>&nbsp;</h1>
	</div>  
			...
			<tbody>
				...
				<asp:Literal ID="lblTitle" runat="server" Text='<%# Eval("title") %>'></asp:Literal>
					...
					<td class="control"  style=" width:140px">
						<%#isEdit?"<a href=\"javascript:bombbox.openBox('group_edit.aspx?id="+Eval("id")+"');\" class=\"btn btn6\">重命名</a>":""%>
                         <asp:LinkButton ID="lbtnDelete" CssClass="btn btn6" Visible='<%#isDelete %>' CommandArgument='<%# Eval("id") %>' CommandName="del" OnClientClick="return confirm('您确认要删除吗?');" runat="server" Text='删除'></asp:LinkButton>
					</td>
				</tr>
