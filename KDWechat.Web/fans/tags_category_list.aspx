<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tags_category_list.aspx.cs" Inherits="KDWechat.Web.fans.tags_category_list" %>
        ...
        <section id="main">
            ...
            <div class="titlePanel_01">
                <div class="btns">
                    ...
                    <%="<a href=\"javascript:bombbox.openBox('tags_category_edit.aspx?m_id="+m_id+"');\" class=\"btn btn3\"><i class=\"add\"></i>新建标签分类</a>" %>
                </div>
                <h1>&nbsp;</h1>
            </div>
                ...
                <table cellpadding="0" cellspacing="0" class="table">
                    <thead>
                        <tr>
                            ...
                            <th class="name">标签分类名称</th>
                            <th class="time" style="width: 115px">创建时间</th>
                            <th class="control" style="width: 220px">操作</th>
                        </tr>
                    </thead>
                    <tbody>
                        <asp:Repeater ID="repList" runat="server" OnItemCommand="repList_ItemCommand">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td class="time" style="width: 115px"><%# Eval("creat_time","{0:yyyy/MM/dd HH:mm}") %></td>
                                    <td class="control" style="width: 140px">
                                        <a href='javascript:bombbox.openBox("tags_category_edit.aspx?id=<%#Eval("id") %>");' class="btn btn6">重命名</a>
                                        <a href='javascript:bombbox.openBox("category_tags_relation.aspx?id=<%#Eval("id") %>");' class="btn btn6">选择标签</a>
