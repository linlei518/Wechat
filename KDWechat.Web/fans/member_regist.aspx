<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="member_regist.aspx.cs" Inherits="KDWechat.Web.fans.member_regist" %>
...
<body>
    ...
    <section id="contenter">
	    <div class="titleStyle"><span>凯德会员注册</span></div>
        <div class="content">
            ...
            <div class="formlist"><input name="password" id="txtConfirmPassword" type="password" runat="server" class="text" placeholder="确认密码" maxlength="20" /></div>
        </div>
        <div class="sendBtn">
            <asp:Button ID="btnSubmit" runat="server" CssClass="btn" Text="提交" OnClientClick="return Check()" OnClick="btnSubmit_Click" ></asp:Button>
        </div>  
    </section>
