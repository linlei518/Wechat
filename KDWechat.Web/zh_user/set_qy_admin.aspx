<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="set_qy_admin.aspx.cs" Inherits="KDWechat.Web.zh_user.set_qy_admin" %>
                                ...
                                <ItemTemplate>
                                    <li class="userBaseInfo">
                                        ...
                                        <div class="info">
                                            ...
                                            <p>员工号  ：<%#Eval("user_code") %></p> 
                                            <p>手机号码  ：<%#Eval("user_tel") %></p>
                                        </div>
                                        <div class="btns">
