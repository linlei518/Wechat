<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="model_dic_list.aspx.cs" Inherits="KDWechat.Web.product.model_dic_list" %>
...
<head>
  ...
  <body class="mainbody">
    <form id="form2" runat="server">
        ...
        <!--导航栏-->
         <section id="main">
                    <%=NavigationName %><input name="btnReturn" type="button" value="返回上一页" class="btn btn2" onclick="javascript: history.go(-1);" />
                <div class="titlePanel_01">
                    <div class="btns" runat="server" id="div_add">
                        <a  href="model_dic_edit.aspx?action=ADD&model_id=<%=model_id %>&m_id=<%=m_id %>" class="btn btn3"> <i  class="add"></i>新增</a>
                ...
                <div class="searchField">
                    <input type="text" class="txt searchTxt" placeholder="型号属性名称..." runat="server" id="txtKeywords">
                ...
                <div class="tablePanel_01">
                    <table cellpadding="0" cellspacing="0" class="table">
                        <thead>
                            <tr>
                           <th width="5%">选择</th>
                            <th align="left"width="25%">属性名称</th>
                            <th align="left"width="25%">属性值</th>
                        ...
                        <td>
                            <asp:Literal ID="lblTitle" runat="server" Text='<%#true?" <a href=\"model_dic_edit.aspx?action="+Enums.RoleActionType.Edit+"&id="+Eval("id")+"&model_id="+Eval("model_id")+ "&m_id=" + m_id+"\">"+Eval("model_key")+"</a>":Eval("model_key") %>'></asp:Literal></td>
                         <td ><%#Eval("model_val")%></td>
                        ...
                        <td align="center">
                            <%# (true?" <a href=\"model_dic_edit.aspx?action="+Enums.RoleActionType.Edit+"&id="+Eval("id")+"&model_id="+Eval("model_id")+ "&m_id=" +m_id+"\">修改</a>":"") %>
