<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="model_dic_edit.aspx.cs" Inherits="KDWechat.Web.product.model_dic_edit"  validateRequest="false" %>
...
<body class="mainbody">
    ...
    <uc2:MenuList ID="MenuList1" runat="server" />
       ...
       <div class="breadcrumbPanel_01">
                <h1><span>产品列表</span><i class="breadcrumbArrow"></i><em><%=this.id==0?"新建":"编辑" %>产品型号属性</em></h1>
            </div>
       ...
       <div class="listPanel_01 bottomLine">
            <dl>
                <dt>属性名称</dt>
                <dd>
                    <asp:TextBox ID="txtKey" runat="server" CssClass="txt required" datatype="*2-20" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*属性名称名称，20个字符内。</span></dd>
            </dl>
             <dl>
                <dt>属性值</dt>
                <dd>
                    <asp:TextBox ID="txtVal" runat="server" CssClass="txt required" datatype="*2-20" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*属性名称名称，20个字符内。</span></dd>
            </dl>
              <dl>
                <dt>排序数字</dt>
                <dd>
                    <asp:TextBox ID="txtSortId" runat="server" CssClass="txt" Width="50px" datatype="n" sucmsg=" ">99</asp:TextBox>
