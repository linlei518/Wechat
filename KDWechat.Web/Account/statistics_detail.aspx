<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="statistics_detail.aspx.cs" Inherits="KDWechat.Web.Account.statistics_detail" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <section id="main">
	        ...
	        <div class="tablePanel_01" style="padding:0;">
                <div class="tableNTab">
					        ...
					        <td class="info info2">
                                <div class="info2List">
                                    <asp:Repeater ID="repCountry" runat="server">
                                        <ItemTemplate><em title="<%#Eval("key") %>"><div style="overflow:hidden;float:left; max-width:60px"><%#Eval("key") %></div>：<%#Eval("count") %>人</em></ItemTemplate>
                                    </asp:Repeater>
                                </div>
                                <div class="btns">
					        ...
					        <td class="info info2">
                                <div class="info2List">
						            <asp:Repeater ID="repLanguage" runat="server">
                                        <ItemTemplate><em title="<%#Eval("key") %>"><div style="float:left;"><%#Eval("key") %></div>：<%#Eval("count") %>人</em></ItemTemplate>
                                    </asp:Repeater>
                                </div>
                                <div class="btns">
							        <a href="#" class="btn btnInfo"><i class="open"></i>展开</a>
	        ...
	        <div class="statisticsListPanel_01">
		        <div class="listField">
			        ...
			        <div class="statistics">
				        <h3>趋势图 - <%=tagName %></h3>
				        <div class="content" style="height:400px;" id="container">
