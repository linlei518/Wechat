<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_fans_statistics.aspx.cs" Inherits="KDWechat.Web.Account.sys_fans_statistics" %>
    ...
    <form id="form1" runat="server">
        ...
        <script>
            ...
            statisticsContrast.accountSubmit = function (submitValue) {
                ...
                {
                    var url = 'sys_fans_statistics.aspx?Ids=' + encodeURI(ids)+'&m_id=<%=m_id%>';
                    location.href = url;
                }
            ...
            function selectSubDate() //关注选择
            {
                ...
                location.replace("sys_fans_statistics.aspx?Ids="+Ids+"&sub_sdate="+sub_sdate+"&sub_edate="+sub_edate+"&m_id=<%=m_id%>");
            }
            //2.取消关注
            function selectUnDate() //关注选择
            {
                ...
                location.href="sys_fans_statistics.aspx?Ids="+Ids+"&un_sdate="+un_sdate+"&un_edate="+un_edate+"&m_id=<%=m_id%>";
            }
            //3.发送消息
            function selectMsgDate() //关注选择
            {
                ...
                location.href="sys_fans_statistics.aspx?Ids="+Ids+"&Msg_sdate="+Msg_sdate+"&Msg_edate="+Msg_edate+"&m_id=<%=m_id%>";
            }
            //4.接收消息
            function selectRecDate() //关注选择
            {
                ...
                location.href="sys_fans_statistics.aspx?Ids="+Ids+"&Rec_sdate="+Rec_sdate+"&Rec_edate="+Rec_edate+"&m_id=<%=m_id%>";
            }
            //--------------------------日期选择事件结束---------------------------
