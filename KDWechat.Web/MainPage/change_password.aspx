<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="change_password.aspx.cs" Inherits="KDWechat.Web.main.change_password" %>
        ...
        <section id="main">
            ...
            <div class="listPanel_01 bottomLine">
                <dl>
                    <dt>账号名称：</dt>
                    <dd>
                        <asp:TextBox CssClass="txt required" ID="txtAccountName" Enabled="false" runat="server"></asp:TextBox></dd>
                </dl>
                <dl>
                    <dt>原 密 码：</dt>
                    <dd>
                        <asp:TextBox ID="txtOldPassword" CssClass="txt required" TextMode="Password" runat="server" MaxLength="15"></asp:TextBox><i>*</i></dd>
                </dl>
                <dl>
                    <dt>新 密 码：</dt>
                    <dd>
                        <asp:TextBox ID="txtPassword" CssClass="txt required" TextMode="Password" runat="server" MaxLength="15"></asp:TextBox><i>*</i><em>5-15位以内</em></dd>
                </dl>
                <dl>
                    <dt>确认密码：</dt>
                    <dd>
                        <asp:TextBox ID="txtConfirmPasswrod" CssClass="txt required" TextMode="Password" runat="server" MaxLength="15"></asp:TextBox><i>*</i></dd>
                </dl>
            </div>
            <%--前连接地址--%>
