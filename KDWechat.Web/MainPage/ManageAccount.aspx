<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageAccount.aspx.cs" Inherits="KDWechat.Web.main.ManageAccount" %>
                ...
                <asp:Repeater ID="DataRepeater" runat="server" OnItemCommand="DataRepeater_ItemCommand">
                        ...
                        <table cellpadding="0" cellspacing="0" class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="info info1" style="width: 100px">姓名</th>
                                    <th class="info info1" style="width: 80px">账号角色</th>
                                    <th class="info info1" style="width: 100px">类型</th>
                                    <th class="info info1" style="width: 100px">地区</th>
                                    ...
                                    <th class="control" style="width: 210px">操作</th>
                                </tr>
                            </thead>
                            <tbody>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="info info1" ><%#((KDWechat.Common.UserFlag)int.Parse(Eval("flag").ToString())).ToString() %></td>
                            <td class="info info1"  ><%#((KDWechat.Common.BussinessType)int.Parse(Eval("type_id").ToString())).ToString() %></td>
                            <td class="info info1"  ><%#((KDWechat.Common.AreaType)int.Parse(Eval("area").ToString())).ToString() %></td>
                            <td class="info info1"  ><%#((KDWechat.Common.Status)int.Parse(Eval("status").ToString())).ToString() %></td>
                            <td class="info info1"  >
                            <%# Eval("flag").ToString()=="1"?"无":"<a href=\"javascript:bombbox.openBox('WXList.aspx?uid="+Eval("id")+"');\">查看("+GetWxCountByUid(Eval("id").ToString())+")</a>"  %>
                            
                                
                            </td>
                            <td class="info info1"  >
                             <%# Eval("flag").ToString()=="1"?"无":"<a href=\"javascript:bombbox.openBox('ChildrenAccount.aspx?id="+Eval("id")+"');\">"+ ( Eval("uscou")==null?"无":"查看("+Eval("uscou")+")")+"</a>"  %>
                            </td>
                            <td class="info info1"  >
                                <%#GetLastOpreation(Eval("id")) %>
                            </td>
                            <td class="control"  >
                                <%# GetManageMall(Eval("flag"),Eval("id")) %>
