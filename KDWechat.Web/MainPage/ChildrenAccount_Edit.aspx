<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChildrenAccount_Edit.aspx.cs" Inherits="KDWechat.Web.main.ChildrenAccount_Edit" %>
            ...
            <div class="listPanel_01 bottomLine">
                ...
                <dl>
                    ...
                    <dd>
                        ...
                        &nbsp;&nbsp;<em>仅针对素材管理，设置后该管理员仅能查看和管理自己上传的素材。</em></dd>
                </dl>
                <div id="divwx" <%=wx_style %>>
                    <div class="title">
                        <h2>负责微信公众号</h2>
                    </div>
                ...
                <asp:Literal ID="lblChildSysList" runat="server"></asp:Literal>

                <asp:HiddenField ID="hfchild_sys_name" runat="server" />
                <asp:HiddenField ID="hfchild_sys_action" runat="server" />
