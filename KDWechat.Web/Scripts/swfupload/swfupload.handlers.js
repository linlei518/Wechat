...
*	初始化SWFUpload上传控件
* ****************************************** */
function InitSWFUpload(upurl, uppath, upsize, flashurl, iswater, isthumbnail, folder, upload_type) {
    var sendUrl = upurl + "?action=MultipleFile&UpFilePath=" + uppath + "&folder=" + folder + "&upload_type=" + upload_type + "&IsThumbnail=" + isthumbnail;
...
function uploadSuccess(file, serverData) {
    try {
        ...
        if (jsonstr.status == '1') {
            ...
            //}
            addImage(jsonstr.path, jsonstr.thumb);
