<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="template_pic_add.aspx.cs" Inherits="KDWechat.Web.setting.template_pic_add" %>
    ...
    <form id="form1" runat="server">
        ...
        <section id="main" >
	        ...
	        <div class="listPanel_01 bottomLine">
		        <dl>
			        <dt>图片名称：</dt>
			        <dd><asp:TextBox ID="txtTitle" runat="server" CssClass="txt required" MaxLength="50"></asp:TextBox><i>*</i><em>不超过50个字</em></dd>
		        </dl>
                 <dl>
			        <dt>上传图片：</dt>
			        <dd>
                        ...
                        <div class="simulationPanel_00" >
                         ...
                         </div> <input type="button" id="btnUpload" class="btn btn6" value="浏览...">  <label id="lblImg" class="error" style="display: inline;"></label>
                        <%--自己上传调用方法，Upload_File方法在function.js里需引用，目前file控件样式有问题，这里暂不用--%>
				       
				        <br /><i>*</i><em>图片建议大小：不超过2M,格式：bmp, png, jpeg, jpg, gif</em>
			        </dd>
		        </dl>
        ...
        <script type="text/javascript">
            KindEditor.ready(function (K) {
                ...
                var editor = K.editor({
                    uploadJson: '../handles/upload_ajax.ashx?action=EditorFile&IsWater=1&folder=<%=wx_og_id%>&upload_type=<%=(int)KDWechat.Common.media_type.图文模板图片库%>&write=0',
                    fileManagerJson: '../handles/upload_ajax.ashx?action=ManagerFile&folder=<%=wx_og_id%>&upload_type=<%=(int)KDWechat.Common.media_type.图文模板图片库%>',
            ...
            function ckName(value) {
                ...
                $.ajax({
                    type: "POST",
                    async: false,
                    url: "/handles/wechat_ajax.ashx?action=check_exists_name&channel_id=<%=(int)KDWechat.Common.media_type.图文模板图片库%>",
