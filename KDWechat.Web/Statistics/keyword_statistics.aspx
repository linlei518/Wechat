<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="keyword_statistics.aspx.cs" Inherits="KDWechat.Web.Statistics.keyword_statistics" %>
...
<%--			<div class="listNTab">
		    ...
		    <div class="listField">
			    <div class="statistics">
				    <h2><%=startTime.ToShortDateString()+" 至 "+endTime.ToShortDateString() %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;关键词命中条数： <%=hitCount %>条&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;未命中条数：<%=commentsCount %>条</h2>
			    </div>
		    </div>
	    </div>
	    <div class="statisticsListPanel_01">
