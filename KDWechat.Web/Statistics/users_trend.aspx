<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="users_trend.aspx.cs" Inherits="KDWechat.Web.Statistics.users_trend" %>
			    ...
			    <table cellpadding="0" cellspacing="0" class="table" title="showLength:10,from:0">
				    <thead>
					    <tr>
						    ...
						    <th class="info info2 sorts"><i class="sort"></i>新关注人数</th>
						    <th class="info info1 sorts"><i class="sort"></i>取消关注人数</th>
						    <th class="info info1 sorts"><i class="sort"></i>净增关注人数</th>
						    <th class="info info1 sorts"><i class="sort"></i>累计关注人数</th>
					    </tr>
				    </thead>
				    <tbody>
                        <%=detailTable %>
