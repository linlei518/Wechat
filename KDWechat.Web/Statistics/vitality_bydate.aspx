<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vitality_bydate.aspx.cs" Inherits="KDWechat.Web.Statistics.vitality_bydate" %>
                ...
                <div class="listField">
                    <div class="title">
                        <h2>
                            ...
                            <%=startTime.ToShortDateString() %> 至 <%=endTime.ToShortDateString() %>粉丝活跃度统计<br />注：粉丝活跃度由用户留言、菜单点击、地理位置上传和图文浏览组成。具体公式为 (一个月内留言数+菜单点击数+地理位置上传次数+图文浏览次数)*100/(目前关注粉丝数*天数)</h2>
                    </div>
                    <div class="statistics">
                        <div class="content" id="containerBar" style="height:<%=vitalityHeight%>px">
                        </div>
