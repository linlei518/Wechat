<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reply_bydate.aspx.cs" Inherits="KDWechat.Web.Statistics.reply_bydate" %>
                ...
                <div class="listField">
                    <div class="title">
                        <h2>
                            ...
                            <%=startTime.ToShortDateString()  %> 至 <%=endTime.ToShortDateString() %> 用户留言统计</h2>
                        </div>
