<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="activity_apply_edit.aspx.cs" Inherits="KDWechat.Web.activity.activity_apply_edit"  %>
...
<body >
    ...
    <uc2:MenuList ID="MenuList1" runat="server" />
       ...
       <div class="breadcrumbPanel_01">
                <h1><span>报名信息列表</span><i class="breadcrumbArrow"></i><em>查看报名信息</em></h1>
            </div>
       ...
       <div class="listPanel_01 bottomLine">
            <dl>
                <dt>用户昵称</dt>
                <dd>
                    <asp:TextBox ID="txtnick_name" runat="server" CssClass="txt required" datatype="*2-20" sucmsg=" "></asp:TextBox>
             ...
             <dl>
                <dt>头像</dt>
               <dd>
                    <asp:Image runat="server" ID="head_img_url" Height="200px" Width="200px"/>
