<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="invitation_edit.aspx.cs" Inherits="KDWechat.Web.activity.invitation_edit"  %>
...
<body >
    ...
    <uc2:MenuList ID="MenuList1" runat="server" />
       ...
       <div class="breadcrumbPanel_01">
                <h1><span>邀请函列表</span><i class="breadcrumbArrow"></i><em>查看邀请函</em></h1>
            </div>
       ...
       <div class="listPanel_01 bottomLine">
            <dl>
             ...
             <dl>
                <dt>职务</dt>
               <dd>
                    <asp:TextBox ID="txtpost" runat="server" CssClass="txt required" datatype="*2-20" sucmsg=" "></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>申请时间</dt>
