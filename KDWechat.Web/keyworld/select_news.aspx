<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="select_news.aspx.cs" Inherits="KDWechat.Web.keyworld.select_news" %>
                            ...
                            <ItemTemplate>
                                ...
                                <li  class="sigle">
                                    ...
                                    <div class="control">
                                        ...
                                        <input type="hidden" class="summary" value="<%# KDWechat.Common.Utils.DropHTML( Eval("summary").ToString(),140) %>" />
                                     <%--   <%# (is_public==1?"":"<a href='/material/news_add.aspx?id="+Eval("id")+"&tef=1895623541' class='btn edit' title='编辑' type='button'></a>") %>
